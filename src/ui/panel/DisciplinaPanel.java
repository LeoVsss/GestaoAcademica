...
public class DisciplinaPanel extends JPanel {
    ...
    public final JFormattedTextField  txtDataInicio    = createDateField();
    public final JFormattedTextField  txtDataEnc       = createDateField();
    ...
    public java.util.Date getDataInicio() throws ParseException {
        String text = txtDataInicio.getText().trim();
        return sdf.parse(text);
    }

    public java.util.Date getDataEncerramento() throws ParseException {
        String text = txtDataEnc.getText().trim();
        return sdf.parse(text);
    }
