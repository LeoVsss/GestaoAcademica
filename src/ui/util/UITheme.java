...
/**
 * SRP: centraliza tema visual (cores, fontes, estilos) da aplicação.
 * OCP: novas constantes podem ser adicionadas sem modificar consumidores.
 */
public final class UITheme {

    // Paleta de cores
    public static final Color PRIMARY        = new Color(37, 99, 235);   // Azul
    public static final Color PRIMARY_HOVER  = new Color(29, 78, 216);
    public static final Color SUCCESS        = new Color(22, 163, 74);   // Verde
    public static final Color DANGER         = new Color(220, 38, 38);   // Vermelho
    public static final Color WARNING        = new Color(217, 119, 6);   // Laranja
    public static final Color SURFACE        = new Color(248, 250, 252); // Fundo painel
    public static final Color HEADER_BG      = new Color(15, 23, 42);    // Header escuro
    ...
    /** Cria um JButton estilizado com cor de fundo personalizada. */
    ...
    /** Cria um JTextArea com estilo padrão. */
    ...
    /** Estiliza o cabeçalho de uma JTable. */
